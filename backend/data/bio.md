...
## Intereses
Apasionado por la Inteligencia Artificial aplicada a problemas reales.
Me gusta entender cómo funcionan las cosas por dentro — por eso uso Neovim y Linux
en vez de los caminos más fáciles. Creo que las bases sólidas importan más que seguir
cada framework de moda.

## Tiempo libre y hobbies
Cuando no estoy programando, voy al gimnasio — entreno fuerza con foco en la salud, no en la estética.
Me gusta aprovechar cada momento libre para aprender algo nuevo: un concepto, una tecnología, una habilidad.
Prefiero invertir el tiempo en crecer antes que en videojuegos o salidas nocturnas.
También disfruto mucho hablar y conocer gente — las conversaciones con personas nuevas me energizan.

## Comunicación / Hablar con gente / Hablar en público / Compañeros de trabajo
A Leandro le encanta hablar con la gente — lo disfruta genuinamente. Considera que toda persona tiene algo valioso para aportar, sin importar su rol o experiencia, y eso lo hace conectar fácilmente con cualquiera.
...
Soy una persona activa, sincera y muy dedicada. Siempre estoy haciendo algo — no me gusta el tiempo muerto.
Digo lo que pienso, pero desde un lugar de cariño: si veo algo que alguien puede mejorar, lo digo.
Y también me gusta hacer cumplidos genuinos — creo que una sola palabra puede cambiarle el día a alguien.

Me considero un amante del aprendizaje. Mi visión a futuro es tener mucho conocimiento y usarlo para guiar a otros.
En el trabajo soy muy dedicado y busco hacer las cosas casi perfectas — no sé si es una virtud o una trampa, pero así soy.
Puedo ser muy serio cuando la situación lo requiere, y muy gracioso cuando el momento lo permite.
Soy fiel a mis convicciones y a lo que creo.

## Visión profesional a futuro

En dos o tres años, mi meta es haberme consolidado como desarrollador Mid-level con impacto directo en la arquitectura de los productos de la empresa.

Me veo dominando no solo el código, sino todo el ciclo de vida del software: desde la optimización de bases de datos hasta el deploy eficiente en la nube. También quiero seguir especializándome en la integración de IA en el desarrollo, para ayudar al equipo a ser más productivo e implementar soluciones inteligentes que marquen la diferencia.
...
Cree que el entorno donde trabajás te forma tanto como los proyectos que hacés.
...
## Cómo aprende / Método de aprendizaje / Qué hace cuando se traba
Leandro tiene un proceso de aprendizaje estructurado y moderno:

1. **Documentación oficial primero** — siempre arranca desde la fuente, no de tutoriales de terceros.
2. **IA como herramienta activa** — usa NotebookLM y Copilot pasándoles el contexto que está leyendo para profundizar, hacer preguntas y validar lo que entendió.
3. **Práctica inmediata** — no da por aprendido algo hasta que lo implementó. El código es la prueba.
4. **Referentes como segundo opinión** — si algo todavía no cierra, busca videos de las personas que sigue para ver distintas posturas y perspectivas sobre el mismo tema.

Este proceso le permite aprender de forma autónoma y llegar a los conceptos con solidez, no solo con copia y pega.

## Metodologías ágiles / Scrum / Kanban / Agile
...
Su forma de resolverlo es pragmática: usa IA como herramienta de apoyo y estudia ejemplos de páginas bien diseñadas para tomar referencias y acelerar el proceso. No pretende que no existe el problema — lo reconoce y trabaja activamente para mejorarlo.

Dicho esto, su pasión y mayor fortaleza está en el backend: arquitectura, APIs, bases de datos, lógica de negocio. Ahí es donde se siente más en su elemento y donde quiere especializarse.
...
Si alguien propone algo que considero un error técnico o financiero, aplico la validación estratégica: digo algo como "Es un punto interesante, analicémoslo en detalle más tarde". Esto me permite mantener la armonía, no herir el crédito de la otra persona y, en el momento oportuno, guiar la decisión hacia lo que realmente beneficia al proyecto — basándonos en datos, no en egos.

En mis proyectos uso Git con ramas, PRs y conventional commits como si trabajara en equipo.

**¿Cuál fue tu mayor desafío técnico y cómo lo resolviste?**
Implementar autenticación con JWT desde cero. Al principio me costó entender la lógica de seguridad y el manejo de tokens de forma manual — es uno de esos temas donde si no entendés los fundamentos, cualquier implementación es un agujero de seguridad.

Lo resolví con estudio profundo y práctica constante. Más adelante, en mi e-commerce PremiumTech, apliqué esa base combinándola con Claude Code para agilizar el proceso y asegurar las mejores prácticas.
