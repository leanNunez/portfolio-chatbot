    ...
    >
      <div className="max-w-3xl mx-auto flex gap-3 items-center">
        <input
          ...
          className="flex-1 bg-white/[0.05] text-white placeholder-gray-600 rounded-xl px-5 py-3.5 text-base outline-none
        ...
        <button
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-violet-600
            ...
            text-white rounded-xl px-5 py-3.5 text-sm font-medium
